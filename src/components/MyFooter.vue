        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
            <div>
                <div class="flex gap-2 mb-5">
                    <h1 class="text-white font-bold text-2xl">Rob<span class="text-secondary">Sage</span>me</h1>
                ...
                <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloremque id perspiciatis inventore quidem iste! Possimus, ut. Repudiandae facilis eos commodi dolorum, consequuntur nihil saepe aliquam vitae obcaecati illum laudantium labore.</p>
            ...
            <div class="grid">
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="#" class="hover:undlerline">About Us</a>
                        <a href="#" class="hover:undlerline">Feature</a>
                        <a href="#" class="hover:undlerline">Career</a>   
                    </div>
                    <div></div>
                    <div></div>
                </div>
